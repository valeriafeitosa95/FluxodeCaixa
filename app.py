...
with col5:
    ...
    fig.update_layout(title_text = 'Entradas', title_xref='paper', title_font_color='White')
...
with col6:  
    ...
    fig.update_layout(title_text = 'Saídas', title_xref='paper', title_font_color='White')
    fig.update_layout(separators=".,", showlegend = False)
    fig.update_layout(paper_bgcolor='#9E0000', plot_bgcolor='#9E0000')
    fig.update_yaxes(visible=False)
    fig.update_xaxes(title = ' ')
...
fig.update_layout(title_text = 'Entradas x Saídas por Ano', title_xref='paper', title_font_color='White' )
fig.update_layout(separators=".,", autotypenumbers='strict')
